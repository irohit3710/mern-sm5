...
const DesktopJoinGroupSignINModal = (props) => {
  ...
  return (
    ...
    >
      <div className="max-h-[97vh] overflow-y-auto sm:w-full md:w-full">
        <div className="bg-white-A700 flex flex-col items-center justify-start mb-[195px] pb-2 md:px-5 rounded-lg w-full">
          <div className="flex flex-col gap-[26px] items-center justify-start w-full">
            ...
            <div className="flex md:flex-col flex-row gap-6 items-start justify-start w-[91%] md:w-full">
              <div className="flex flex-col gap-[25px] items-center justify-start w-[49%] md:w-full">
                <div className="flex flex-col items-start justify-start w-full">
                  <a
                    href="javascript:"
                    className="text-2xl md:text-[22px] text-black-900 sm:text-xl"
                  >
                    <Text size="txtIBMPlexSansBold24">Sign In</Text>
                  </a>
                  <div className="flex flex-col gap-[19px] items-center justify-start mt-5 w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Text
                        className="bg-gray-100_02 border border-blue_gray-100 border-solid h-[46px] justify-center pl-3 sm:pr-5 pr-[35px] py-[13px] rounded-tl-sm rounded-tr-sm text-[15px] text-blue_gray-400 w-80"
                        size="txtIBMPlexSansMedium15Bluegray400"
                      >
                        Email
                      </Text>
                      <div className="bg-gray-100_02 border border-blue_gray-100 border-solid flex flex-row items-center justify-between p-3 rounded-bl-sm rounded-br-sm w-full">
                        <Text
                    ...
                    <Button className="bg-blue-A700 cursor-pointer font-semibold min-w-[320px] py-[11px] rounded-[20px] text-center text-sm text-white-A700">
                      Sign In
                    </Button>
                  </div>
                  <div className="bg-white-A700 border border-blue_gray-100_01 border-solid flex flex-col items-center justify-end mt-6 p-2 rounded-sm w-full">
                    <div className="flex flex-row gap-2.5 items-start justify-center mt-0.5 w-[54%] md:w-full">
                      <Img
                  ...
                  <Button
                    className="common-pointer bg-white-A700 border border-blue_gray-100_01 border-solid cursor-pointer flex items-center justify-center min-w-[320px] mt-2 px-[34px] py-[9px] rounded-sm"
                ...
                <a
                  href="javascript:"
                  className="text-black-900 text-center text-xs tracking-[-0.10px]"
                >
                  <Text size="txtIBMPlexSansMedium12">Forgot Password?</Text>
                </a>
              </div>
              <div className="flex flex-col gap-[30px] items-end justify-start md:mt-0 mt-[5px] w-[49%] md:w-full">
                <Text
                  className="text-[13px] text-gray-800 text-right"
                  size="txtIBMPlexSans13"
                >
                ...
                <div className="flex flex-col h-80 items-center justify-start w-80">
...
export default DesktopJoinGroupSignINModal;
