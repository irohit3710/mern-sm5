...
const LoggedInUserScrolledFollowGroupsClickedPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-ibmplexsans h-[1024px] mx-auto relative w-full">
        <div className="absolute bottom-[0] h-[1709px] sm:h-[1825px] md:h-[2445px] inset-x-[0] mx-auto md:px-5 w-full">
        ...
        <div className="absolute flex flex-col gap-8 items-center justify-start md:px-5 right-[14%] top-[19%] w-[17%]">
        ...
        <Text
          className="absolute right-[17%] text-black-900 text-sm top-[33%] tracking-[1.40px] uppercase"
          size="txtIBMPlexSans14"
        >
          REcommended Groups
        </Text>
        <div className="absolute flex flex-col gap-[54px] h-max inset-y-[0] items-end justify-start my-auto md:px-5 right-[14%] w-[17%]">
          <List
          ...
          >
            <div className="flex flex-1 flex-row items-center justify-start my-0 w-full">
              ...
              <Button className="bg-black-900 cursor-pointer leading-[normal] min-w-[73px] ml-[73px] my-1.5 py-1 rounded-[12px] text-center text-white-A700 text-xs">
                Followed
              </Button>
            </div>
            <div className="flex flex-1 flex-row items-center justify-start my-0 w-full">
          ...
          <Text
            className="text-blue-A700 text-right text-xs"
        ...
        <Img
          className="absolute h-2.5 right-[30%] top-[34%] w-[9px]"
          src="images/img_contrast_black_900.svg"
          alt="contrast"
        />
        <Img
          className="absolute h-[15px] right-[30%] top-[33%] w-4"
